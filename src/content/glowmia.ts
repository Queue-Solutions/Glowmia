...
export const glowmiaCopy: CopyTree = {
  ...
  checkout: {
    ...
    requiredError: {
      en: 'Please fill the required order fields, including your email, and keep at least one dress selected.',
      ar: 'يرجى تعبئة حقول الطلب المطلوبة بما فيها البريد الإلكتروني والإبقاء على فستان واحد على الأقل.',
    },
